...
--
-- Host: 127.0.0.1
-- Tempo de geração: 10-Jun-2022 às 03:18
...
(4, 'admin@ossuna.com', 'asdf4321', 'Administrador Master', '284.389.873-03', 21, '82988889999', 4, b'0'),
...
--
ALTER TABLE `t_endereco`
  ADD CONSTRAINT `fk_t_endereco_t_usuario_1` FOREIGN KEY (`id_usuario`) REFERENCES `t_usuario` (`id_usuario`);
