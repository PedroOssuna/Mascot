CREATE DATABASE IF NOT EXISTS `mascot` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;
...
ALTER TABLE `t_endereco` ADD CONSTRAINT `fk_t_endereco_t_usuario_1` FOREIGN KEY (`id_usuario`) REFERENCES `t_usuario` (`id_usuario`);
